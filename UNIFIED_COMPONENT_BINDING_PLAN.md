...
- [x] Do not synthesize icon, label, track, or handle elements unless the user explicitly requests one.
...
- [x] Keep advanced selector and authored-source controls available behind Advanced.
