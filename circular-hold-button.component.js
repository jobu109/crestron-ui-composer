(function (runtime) {
  ...
  runtime.register({
    ...
    signals: [
      ...
      { key: "label", name: "Standard name", type: "serial", direction: "input", defaultValue: "CircularHoldButton.Label" },
      { key: "pressedLabel", name: "Pressed name", type: "serial", direction: "input", defaultValue: "CircularHoldButton.PressedLabel" },
      { key: "selectedLabel", name: "Selected name", type: "serial", direction: "input", defaultValue: "CircularHoldButton.SelectionLabel" },
      { key: "completedLabel", name: "Completed name", type: "serial", direction: "input", defaultValue: "CircularHoldButton.CompletedLabel" },
