(function (runtime) {
  ...
  runtime.register({
    ...
    signals: [
      ...
      { key: "label", name: "Standard name", type: "serial", direction: "input", defaultValue: "HoldButton.Name" },
      { key: "pressedLabel", name: "Pressed name", type: "serial", direction: "input", defaultValue: "HoldButton.PressedName" },
      { key: "selectedLabel", name: "Selected name", type: "serial", direction: "input", defaultValue: "HoldButton.SelectionName" },
      { key: "completedLabel", name: "Completed name", type: "serial", direction: "input", defaultValue: "HoldButton.CompletedName" },
