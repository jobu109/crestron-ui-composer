(function (runtime) {
  ...
  runtime.register({
    ...
    mount(root, context) {
      const button = root.querySelector(".ipb-button"), face = root.querySelector(".ipb-face"), symbol = root.querySelector(".ipb-symbol"), text = root.querySelector(".ipb-text"), name = root.querySelector(".ipb-name"), p = context.options.properties || {}, fallback = p.text || "POWER";
