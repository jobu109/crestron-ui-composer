(function (runtime) {
  ...
  runtime.register({
    ...
    mount(root, context) {
      ...
      const chosenSymbol = p.symbol || "⏻";
      if (chosenSymbol === "⏻")
        symbol.innerHTML = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2v9"></path><path d="M7.1 5.7a8 8 0 1 0 9.8 0"></path></svg>';
      else symbol.textContent = chosenSymbol;
