(function (runtime) {
  ...
  const buttonStyles =
    ...
    '[data-component^="neumorphic-"] .neo-button-icon{width:var(--icon-size-percent);height:var(--icon-size-percent);min-height:20px;stroke:currentColor;fill:none;stroke-width:2;filter:none}' +
    ...
    '[data-component^="neumorphic-"] .neo-button.pressed,[data-component^="neumorphic-"] .neo-button.active{box-shadow:inset calc(var(--shadow-distance-px) * .75) calc(var(--shadow-distance-px) * .75) calc(var(--shadow-distance-px) * 1.5) var(--selected-shadow-dark-color),inset calc(var(--shadow-distance-px) * -.75) calc(var(--shadow-distance-px) * -.75) calc(var(--shadow-distance-px) * 1.5) var(--selected-shadow-light-color),0 0 var(--glow-strength-px) color-mix(in srgb,var(--selected-glow-color) 75%,transparent);color:var(--selected-color);background:var(--selected-surface-color)}' +
    '[data-component^="neumorphic-"] .neo-button.active .neo-button-icon{filter:drop-shadow(0 0 5px var(--selected-glow-color))}';
  ...
  function registerButton(id, name, shape, defaultIcon) {
    runtime.register({
      ...
      properties: [
        ...
        { key: "selectedShadowDarkColor", name: "Selected dark shadow", type: "color", defaultValue: "#1a1c21" },
        { key: "shadowLightColor", name: "Light shadow", type: "color", defaultValue: "#3e444f" },
        { key: "selectedShadowLightColor", name: "Selected light shadow", type: "color", defaultValue: "#3e444f" },
        ...
        { key: "selectedGlowColor", name: "Selected glow color", type: "color", defaultValue: "#04dcb9" },
        { key: "textSize", name: "Text size", type: "number", min: 8, max: 42, step: 1, defaultValue: 16 },
        { key: "iconSize", name: "Icon size (%)", type: "number", min: 10, max: 90, step: 1, defaultValue: 38 },
      ...
      mount(root, context) {
        ...
        context.signals.subscribe("selected", value => {isSelected=value === true || value === 1 || value === "1";button.classList.toggle("active",isSelected);renderState()});
        context.signals.subscribe("label", value => {remoteLabel=value == null || value === "" ? "" : String(value);renderState()});
  ...
  runtime.register({
    ...
    properties: [
      ...
      { key: "textColor", name: "Text color", type: "color", defaultValue: "#ffffff" }, { key: "labelSize", name: "Label size", type: "number", min: 8, max: 36, step: 1, defaultValue: 16 }, { key: "valueSize", name: "Percentage size", type: "number", min: 8, max: 42, step: 1, defaultValue: 22 }, { key: "glowStrength", name: "Glow strength", type: "number", min: 0, max: 30, step: 1, defaultValue: 8 }, { key: "showLabel", name: "Show label", type: "checkbox", defaultValue: true }, { key: "showPercentage", name: "Show percentage", type: "checkbox", defaultValue: true },
    ],
    ...
    styles: '[data-component="neumorphic-volume-knob"]{display:block;width:100%;height:100%;padding:10px;box-sizing:border-box;font-family:"Segoe UI",sans-serif;touch-action:none}[data-component="neumorphic-volume-knob"] *{box-sizing:border-box}[data-component="neumorphic-volume-knob"] .neo-knob-control{display:grid;grid-template-rows:minmax(0,1fr) auto;place-items:center;width:100%;height:100%}[data-component="neumorphic-volume-knob"] .neo-knob-wrap{position:relative;height:100%;max-width:100%;aspect-ratio:1;touch-action:none}[data-component="neumorphic-volume-knob"] svg{position:absolute;z-index:2;inset:0;width:100%;height:100%;pointer-events:none}[data-component="neumorphic-volume-knob"] .neo-track{fill:none;stroke:var(--shadow-dark-color);stroke-width:14;opacity:.55}[data-component="neumorphic-volume-knob"] .neo-arc-bg{fill:none;stroke:var(--shadow-dark-color);stroke-width:6}[data-component="neumorphic-volume-knob"] .neo-arc{fill:none;stroke-width:6;stroke-linecap:round}[data-component="neumorphic-volume-knob"] .neo-knob-face{position:absolute;z-index:1;inset:11%;display:flex;align-items:center;justify-content:center;border-radius:50%;background:var(--surface-color);box-shadow:8px 8px 16px var(--shadow-dark-color),-8px -8px 16px var(--shadow-light-color);cursor:grab}[data-component="neumorphic-volume-knob"] .neo-knob-inner{display:flex;align-items:center;justify-content:center;width:70%;height:70%;border-radius:50%;background:var(--surface-color);box-shadow:inset 4px 4px 8px var(--shadow-dark-color),inset -4px -4px 8px var(--shadow-light-color)}[data-component="neumorphic-volume-knob"] .neo-knob-value{color:var(--text-color);font-size:var(--value-size-px);font-weight:700}[data-component="neumorphic-volume-knob"] .neo-knob-name{color:var(--text-color);font-size:var(--label-size-px);font-weight:700;text-align:center}',
    mount(root, context) {
