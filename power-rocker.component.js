(function (runtime) {
  ...
  runtime.register({
    ...
    template:
      '<div class="power-rocker-root"><button class="power-rocker" type="button" aria-label="Power"><span class="rocker-face"><span class="rocker-mark on-mark">I</span><span class="rocker-mark off-mark">O</span><span class="rocker-led"></span></span></button><span class="rocker-name">POWER</span></div>',
    styles:
      '[data-component="power-rocker"]{display:block;width:100%;height:100%;padding:7%;box-sizing:border-box;font-family:"Segoe UI",sans-serif}[data-component="power-rocker"] *{box-sizing:border-box}[data-component="power-rocker"] .power-rocker-root{display:grid;grid-template-rows:minmax(0,1fr) auto;gap:8px;width:100%;height:100%;align-items:center;justify-items:center}[data-component="power-rocker"] .power-rocker{position:relative;width:min(100%,100vh);height:min(100%,100vw);max-width:100%;max-height:100%;aspect-ratio:1;padding:9%;border:1px solid var(--border-color);border-radius:50%;appearance:none;background:radial-gradient(circle at 42% 35%,color-mix(in srgb,var(--rim-color) 74%,#fff),var(--rim-color) 58%,#050606 100%);box-shadow:inset 0 3px 6px rgba(255,255,255,.12),inset 0 -8px 14px rgba(0,0,0,.75),0 0 var(--glow-strength-px) color-mix(in srgb,var(--glow-color) 45%,transparent),0 8px 16px rgba(0,0,0,.4);cursor:pointer;perspective:500px;touch-action:none}[data-component="power-rocker"] .rocker-face{position:relative;display:block;width:100%;height:100%;overflow:hidden;border:2px solid color-mix(in srgb,var(--border-color) 72%,#000);border-radius:50%;background:radial-gradient(circle at 45% 35%,color-mix(in srgb,var(--face-color) 74%,#fff),var(--face-color) 58%,color-mix(in srgb,var(--face-color) 68%,#000));box-shadow:inset 0 8px 14px rgba(255,255,255,.08),inset 0 -12px 18px rgba(0,0,0,.48),0 2px 5px rgba(0,0,0,.8);transform:rotateX(-8deg);transition:transform .28s,box-shadow .28s}[data-component="power-rocker"] .power-rocker.on .rocker-face{box-shadow:inset 0 13px 17px rgba(0,0,0,.52),inset 0 -5px 12px rgba(255,255,255,.08),0 2px 5px rgba(0,0,0,.8);transform:rotateX(8deg)}[data-component="power-rocker"] .rocker-mark{position:absolute;left:50%;transform:translateX(-50%);color:rgba(255,255,255,.44);font:800 clamp(13px,9%,24px)/1 Arial,sans-serif;text-shadow:0 1px 2px #000;pointer-events:none}[data-component="power-rocker"] .on-mark{top:13%}[data-component="power-rocker"] .off-mark{bottom:13%}[data-component="power-rocker"] .rocker-led{position:absolute;left:50%;bottom:20%;width:var(--led-size-px);height:var(--led-size-px);transform:translateX(-50%);border:2px solid rgba(0,0,0,.65);border-radius:50%;background:var(--off-led-color);box-shadow:inset 2px 2px 3px rgba(255,255,255,.4),inset -2px -3px 4px rgba(0,0,0,.48),0 0 calc(var(--glow-strength-px) * .8) var(--off-led-color);transition:background .25s,box-shadow .25s}[data-component="power-rocker"] .power-rocker.on .rocker-led{background:var(--on-led-color);box-shadow:inset 2px 2px 3px rgba(255,255,255,.5),inset -2px -3px 4px rgba(0,0,0,.42),0 0 var(--glow-strength-px) var(--on-led-color)}[data-component="power-rocker"] .power-rocker.pressed .rocker-face{filter:brightness(1.13)}[data-component="power-rocker"] .rocker-name{max-width:100%;overflow:hidden;color:var(--text-color);font:800 var(--text-size-px)/1.1 "Segoe UI",sans-serif;text-align:center;text-overflow:ellipsis;text-shadow:0 2px 4px rgba(0,0,0,.8),0 0 calc(var(--glow-strength-px) * .45) var(--glow-color);white-space:nowrap}',
    mount(root, context) {
