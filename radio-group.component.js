    ...
    mount(root, context) {
      ...
      function build(nextCount) {
        ...
        for (let index = 0; index < count; index += 1) {
          ...
          context.signals.subscribeAddress("serial", address(p.labelBase, index), value => { if (value != null) text.textContent = String(value); });
