  ...
  global.ComposerRuntime.register({
    ...
    properties: [
      ...
      },
      {
        ...
        type: "text",
        defaultValue: "RollingMenu.Selected.Set",
        signalSetting: true,
      },
      {
        key: "selectedOutSignal",
        ...
        type: "text",
        defaultValue: "RollingMenu.Selected.Value",
        signalSetting: true,
      },
      {
        key: "defaultCount",
      ...
      },
      {
        ...
        type: "text",
        defaultValue: "RollingMenu.Items.{n}.Press",
        signalSetting: true,
      },
      {
        key: "feedbackBase",
        ...
        type: "text",
        defaultValue: "RollingMenu.Items.{n}.Selected",
        signalSetting: true,
      },
      {
        key: "labelBase",
        ...
        type: "text",
        defaultValue: "RollingMenu.Items.{n}.Label",
        signalSetting: true,
      },
      {
        key: "signalIncrement",
