  ...
  global.ComposerRuntime.register({
    ...
    properties: [
      ...
      },
      {
        ...
        type: "text",
        defaultValue: "RollingMenu[0].ItemCount",
        signalSetting: true,
      },
      {
        key: "selectedSetSignal",
        ...
        type: "text",
        defaultValue: "RollingMenu[0].SelectedSet",
        signalSetting: true,
      },
      {
        key: "selectedOutSignal",
        ...
        type: "text",
        defaultValue: "RollingMenu[0].SelectedFeedback",
        signalSetting: true,
      },
      {
        key: "defaultCount",
      ...
      },
      {
        ...
        type: "text",
        defaultValue: "RollingMenu[{index}].Press",
        signalSetting: true,
      },
      {
        key: "feedbackBase",
        ...
        type: "text",
        defaultValue: "RollingMenu[{index}].Selected",
        signalSetting: true,
      },
      {
        key: "labelBase",
        ...
        type: "text",
        defaultValue: "RollingMenu[{index}].Label",
        signalSetting: true,
      },
      {
        key: "signalIncrement",
