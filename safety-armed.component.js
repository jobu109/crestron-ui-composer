(function (runtime) {
  ...
  runtime.register({
    ...
    signals: [
      ...
      { key: "label", name: "Standard name", type: "serial", direction: "input", defaultValue: "SafetyArmedOnOff.Name" },
      { key: "selectedLabel", name: "Armed name", type: "serial", direction: "input", defaultValue: "SafetyArmedOnOff.SelectionName" },
      { key: "completedLabel", name: "Completed name", type: "serial", direction: "input", defaultValue: "SafetyArmedOnOff.CompletedName" },
