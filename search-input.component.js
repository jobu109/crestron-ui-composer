(function (runtime) {
  ...
  runtime.register({
    ...
    properties: [
      ...
      { key: "fieldColor", name: "Field background color", type: "color", defaultValue: "#8e99a8" },
      { key: "buttonColor", name: "Search button color", type: "color", defaultValue: "#8e99a8" },
      { key: "borderColor", name: "Border color", type: "color", defaultValue: "#edf3f8" },
      ...
      { key: "glowColor", name: "Glow color", type: "color", defaultValue: "#d9e7f2" },
      ...
      { key: "cornerRadius", name: "Corner radius", type: "number", min: 0, max: 60, step: 1, defaultValue: 38 },
      { key: "glowStrength", name: "Glow strength", type: "number", min: 0, max: 40, step: 1, defaultValue: 10 },
      { key: "fieldOpacity", name: "Field opacity", type: "number", min: 0, max: 100, step: 1, defaultValue: 72 },
    ...
    template: '<div class="search-root"><label class="search-field"><input class="search-native" type="search" inputmode="search" enterkeyhint="search" autocomplete="off" spellcheck="false" aria-label="Search"></label><button class="search-submit" type="button" aria-label="Submit search"><span class="search-icon"></span></button></div>',
    ...
    mount(root, context) {
      const input = root.querySelector(".search-native"), button = root.querySelector(".search-submit"), p = context.options.properties || {}, sendAsTyped = p.sendAsTyped === true || String(p.sendAsTyped).toLowerCase() === "true";
