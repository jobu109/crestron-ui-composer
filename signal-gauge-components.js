(function (runtime) {
  ...
  runtime.register({
    ...
    styles:
      ...
      '[data-component="battery-gauge"] .battery-shell.low:not(.charging){border-color:var(--low-color);filter:brightness(1.15);box-shadow:inset 0 0 18px color-mix(in srgb,var(--low-color) 62%,transparent),0 0 13px var(--low-color),0 0 29px var(--low-color),0 0 45px color-mix(in srgb,var(--low-color) 68%,transparent)}' +
      ...
      '@keyframes battery-charge-halo{0%,100%{filter:brightness(.92)}50%{filter:brightness(1.3)}}@keyframes battery-critical-pulse{0%,100%{filter:brightness(.9);box-shadow:inset 0 0 13px color-mix(in srgb,var(--low-color) 48%,transparent),0 0 9px var(--low-color),0 0 25px color-mix(in srgb,var(--low-color) 72%,transparent)}50%{filter:brightness(1.45);box-shadow:inset 0 0 22px color-mix(in srgb,var(--low-color) 72%,transparent),0 0 18px var(--low-color),0 0 42px var(--low-color),0 0 56px color-mix(in srgb,var(--low-color) 75%,transparent)}}@keyframes battery-bolt-pulse{0%,100%{opacity:.48;transform:translate(-50%,-50%) scale(.88)}50%{opacity:1;transform:translate(-50%,-50%) scale(1.08)}}',
    mount(root, context) {
      const properties = context.options.properties || {},
