(function (runtime) {
  ...
  runtime.register({
    ...
    signals: [
      ...
      { key: "name", name: "Name", type: "serial", direction: "input", defaultValue: "SingleLight.Label" },
    ],
  ...
  runtime.register({
    ...
    signals: [
      ...
      { key: "name", name: "Name", type: "serial", direction: "input", defaultValue: "SingleShade.Label" },
    ],
  ...
  runtime.register({
    ...
    signals: [
      ...
      { key: "name", name: "Name", type: "serial", direction: "input", defaultValue: "SingleMic.Label" },
    ],
