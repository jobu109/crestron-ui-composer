...
assert.ok(javascript.includes('target.capability) option.dataset.sourceCapability'));
assert.ok(javascript.includes('"Source-backed capability"'));
assert.ok(html.includes('id="custom-signal-source-capability"'));
