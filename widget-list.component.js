(function (runtime) {
  ...
  runtime.register({
    ...
    properties: [
      ...
      { key: "useWidgetDefaultSize", name: "Use selected widget's default size", type: "checkbox", defaultValue: true, affectsProperties: true, group: "Included Widget Size" },
      { key: "itemWidth", name: "Custom item width (px)", type: "number", min: 40, max: 1200, defaultValue: 220, visibleWhen: { key: "useWidgetDefaultSize", equals: false }, group: "Included Widget Size" },
      { key: "itemHeight", name: "Custom item height (px)", type: "number", min: 40, max: 1200, defaultValue: 120, visibleWhen: { key: "useWidgetDefaultSize", equals: false }, group: "Included Widget Size" },
